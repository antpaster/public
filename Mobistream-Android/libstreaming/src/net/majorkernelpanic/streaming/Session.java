...
//		}
		...
		//sessionDescription.append("o=- "+mTimestamp+" "+mTimestamp+" IN IP4 "+/*mOrigin*/"0.0.0.0"+"\r\n");
		sessionDescription.append("o=- "+mTimestamp+" "+mTimestamp+" IN IP4 "+"172.17.1.30"+"\r\n");
		sessionDescription.append("s=Unnamed\r\n");
		sessionDescription.append("i=h264\r\n");
		sessionDescription.append("c=IN IP4 "+/*mDestination*/"172.16.1.66"+"\r\n");
		// t=0 0 means the session is permanent (we don't know when it will stop)
		sessionDescription.append("t=0 0\r\n");
		//sessionDescription.append("a=framerate:25.0");
		...
		if (mVideoStream != null) {
			...
			sessionDescription.append("a=control:track=0\r\n");
			sessionDescription.append("a=control:trackID=0\r\n");
		}
