...
public class Camera2VideoFragment2 extends Fragment implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    public MobistreamService mobistreamService;
    ...
    private void addNotification() {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(getActivity(), 0, notificationIntent, PendingIntent.FLAG_CANCEL_CURRENT);
    ...
    private void removeNotification() {
        ...
        getActivity().stopService(new Intent(getActivity(), MobistreamService.class));
        ((NotificationManager)getActivity().getSystemService(Context.NOTIFICATION_SERVICE)).cancel(0);
    }

    private void bindService() {
        getActivity().bindService(new Intent(getActivity(), MobistreamService.class), mobistreamServiceConnection, Context.BIND_AUTO_CREATE);
    }
...
//            mobistreamService.startPreview();
        }
    ...
    @Override
    public void onPause() {
        if (mobistreamService != null) mobistreamService.removeCallbackListener(serviceListener);
        closeCamera();
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            ErrorDialog.newInstance("This device doesnt support Camera2 API.")
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        } catch (InterruptedException e) {
