...
//			mPacketizer.getRtpSocket().setOutputStream(mOutputStream, mChannelIdentifier);
			...
			RtpSocket soc = mPacketizer.getRtpSocket();
			soc.TAG2 = "AUDIO";


			mPacketizer.getRtpSocket().setOutputStream(mOutputStream, (byte)1);
		}
...
//					"b=AS:32\r\n"+
		...
		Log.w("33333333333333", mSessionDescription);
	}
	...
	private void testADTS() throws IllegalStateException, IOException {
		...
		if (mSettings!=null) {
			if (mSettings.contains(key)) {
				...
				mChannel = 1;// Integer.valueOf(s[2]);
				return;
			}
		}
