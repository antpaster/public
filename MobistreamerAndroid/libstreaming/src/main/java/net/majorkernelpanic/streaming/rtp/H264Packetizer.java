...
public class H264Packetizer extends AbstractPacketizer implements Runnable {
	...
	public void run() {
		...
		if(is instanceof  FakeInputStream) {
			streamType = 1;
		}else if (is instanceof MediaCodecInputStream) {
			streamType = 1;
...
//			buffer = new byte[fakeBuffer.length];
//			System.arraycopy(fakeBuffer, 0, buffer, 0, fakeBuffer.length);
