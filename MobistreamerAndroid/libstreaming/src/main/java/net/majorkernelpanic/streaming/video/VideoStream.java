...
public abstract class VideoStream extends MediaStream {
	...
	protected void encodeWithMediaRecorder() throws IOException, ConfNotSupportedException {
		...
		try {
			...
			mMediaRecorder.setOutputFormat(MediaRecorder.OutputFormat.DEFAULT);//MPEG_4  THREE_GPP
	...
	protected void encodeWithFaceCodec() throws IOException{
		Log.d(TAG,"Video encoded using the Fake Video");
		mMode = MODE_FAKE_API;
		mRequestedMode = MODE_FAKE_API;
		fakeInputStream = new FakeInputStream(null);
		mPacketizer.setInputStream(fakeInputStream);
		mPacketizer.start();
		mStreaming = true;
	}
