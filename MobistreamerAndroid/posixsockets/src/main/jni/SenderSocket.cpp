...
SWIGEXPORT jint JNICALL Java_ru_netris_posixsockets_swig_senderJNI_MAX_1BUFFER_1SIZE_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
...
SWIGEXPORT jint JNICALL Java_ru_netris_posixsockets_swig_senderJNI_MAX_1LOG_1MESSAGE_1LENGTH_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  int result;
...
SWIGEXPORT jlong JNICALL Java_ru_netris_posixsockets_swig_senderJNI_new_1SenderSocket(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
...
SWIGEXPORT void JNICALL Java_ru_netris_posixsockets_swig_senderJNI_delete_1SenderSocket(JNIEnv *jenv, jclass jcls, jlong jarg1) {
...
SWIGEXPORT jboolean JNICALL Java_ru_netris_posixsockets_swig_senderJNI_SenderSocket_1connectToHost(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2, jint jarg3) {
  jboolean jresult = 0 ;
  SenderSocket *arg1 = (SenderSocket *) 0 ;
  char *arg2 = (char *) 0 ;
  int arg3 ;
...
SWIGEXPORT jboolean JNICALL Java_ru_netris_posixsockets_swig_senderJNI_SenderSocket_1closeSocket(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jboolean jresult = 0 ;
  SenderSocket *arg1 = (SenderSocket *) 0 ;
  bool result;
...
SWIGEXPORT jint JNICALL Java_ru_netris_posixsockets_swig_senderJNI_SenderSocket_1sendToHost(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jbyteArray jarg2) {
  jint jresult = 0 ;
  SenderSocket *arg1 = (SenderSocket *) 0 ;
  char *arg2 ;
  size_t arg3 ;
